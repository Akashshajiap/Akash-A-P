...
<body class="cbp-spmenu-push">
	...
	<div class="banner">
		...
		<div class="banner-text">	
			<h3>WELCOME TO SMART HEALTH PREDICTION</h3> 
			<p>This Site Helps You to find out your Heart condition and provide various services to make you as a Healthy person. </p>
			<h5><i class="fa fa-phone" aria-hidden="true"></i> <span>9998155362</span></h5>
			<h5><i class="fa fa-envelope-o" aria-hidden="true"></i> <a class="email-link" href="#">smrithirajvnls@gmail.com</a></h5>
	...
	<div class="hmw3layouts">
		...
		<?php
						...
						{
						$b=mysqli_query($con,"SELECT * FROM `article_files` WHERE ARTICLEID='".$r[0]."' limit 1");
						if($m=mysqli_fetch_array($b))
						{
						?>
	    ...
	    <img src="DOCTOR/ARTICLE/<?php echo $m[2];?>"  alt="" style="height:400px; width:400px">				
			</div>
			<div class="col-md-7 hmw3layouts-left w3right">
				<h5><?php echo $r[3];?></h5>
				<p><?php  echo $r[4];?>.</p>
				<a class="btn btn-1 btn-1d" href="articles.php"> Read More </a>
			</div>				
	...
	<div class="services" id="services">
		<div class="container">
			...
			<p class="title">We provide best services for users...</p>			
			<div class="service-agileinfo">
				<div class="col-md-4 col-sm-4 srvc-wthreegrids">
					...
					<h5>Doctors</h5>
					<p> Provide various health articles and tips .Also help Patients.</p>
				</div>
				<div class="col-md-4 col-sm-4 srvc-wthreegrids">
					<div class="srvc-img">
						<i class="fa fa-medkit" aria-hidden="true"></i>
					</div>
					<h5>Online Medicines</h5>
					<p>Helps the Patients to buy their prescribed medicine. </p>
				</div>
				<div class="col-md-4 col-sm-4 srvc-wthreegrids">
				...
				<i class="fa fa-file-text-o"></i> </a>
					...
					<h5>Pescription</h5>
					<p>Doctors give prescription to patients </p>
				</div>
				<div class="clearfix"> </div>				
			</div>
		</div>
	...
	<div class="footer-bottom">
		<div class="container">
			<div class="footer-left">
				<p>© 2024 Smart Health Prediction . All rights reserved </p>		
			</div>
	...
	<script type="text/javascript" src="medi_plus-web_Free03-01-2017_869291191/web/js/numscroller-1.0.js"></script>
